import { BlankNode, DataFactory as DF, NamedNode, Parser, Quad, termFromId } from '../src';
...
describe('Parser', () => {
  ...
  describe('A Parser instance', () => {
    ...
    it(
      'should parse three triples while there are comments',
      shouldParse('<a> <b> <c>.\n<d> <e> <f>.\n<g> <h> <i>. # @group start collection',
        ['a', 'b', 'c'],
        ['d', 'e', 'f'],
        ['g', 'h', 'i']),
    );
    ...
    it('should throw on syntax errors if no callback is given', () => {
      expect((() => {
        new Parser().parse('<a> bar <c>');
      })).toThrowError('Unexpected "bar" on line 1.');
    });

    it('should throw on grammar errors if no callback is given', () => {
      expect((() => {
        new Parser().parse('<a> <b> <c>');
      })).toThrow('Expected entity but got eof on line 1');
    });
  ...
  describe('An Parser instance with a document IRI', () => {
    function parser() {
      return new Parser({ baseIRI: 'http://ex.org/x/yy/zzz/f.ttl' });
    }
  ...
  describe('A Parser instance with a blank node prefix', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, blankNodePrefix: '_:blank' });
    }
  ...
  describe('A Parser instance with an empty blank node prefix', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, blankNodePrefix: '' });
    }
  ...
  describe('A Parser instance with a non-string format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 1 });
    }
  ...
  describe('A Parser instance for the Turtle format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'Turtle' });
    }
  ...
  describe('A Parser instance for the TurtleStar format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'TurtleStar' });
    }
  ...
  describe('A Parser instance for the TriG format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'TriG' });
    }
  ...
  describe('A Parser instance for the TriGStar format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'TriGStar' });
    }
  ...
  describe('A Parser instance for the N-Triples format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N-Triples' });
    }
  ...
  describe('A Parser instance for the N-TriplesStar format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N-TriplesStar' });
    }
  ...
  describe('A Parser instance for the N-Quads format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N-Quads' });
    }
  ...
  describe('A Parser instance for the N-QuadsStar format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N-QuadsStar' });
    }
  ...
  describe('A Parser instance for the N3 format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N3' });
    }
  ...
  describe('A Parser instance for the N3Star format', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N3Star' });
    }
  ...
  describe('A Parser instance for the N3 format with the explicitQuantifiers option', () => {
    function parser() {
      return new Parser({ baseIRI: BASE_IRI, format: 'N3', explicitQuantifiers: true });
    }
  ...
  describe('A Parser instance with a custom DataFactory', () => {
    ...
    let parser;
    beforeAll(() => {
      factory.quad = function (s, p, o, g) {
        return { s: s, p: p, o: o, g: g };
      };
  ...
  describe('A Parser instance for comments', () => {
    function parser() {
      return new Parser({ lexerOptions: { comments: true } });
    }
    ...
    it(
      ...
      (done) => {
          ...
          const results = [];
          new parser({ baseIRI: BASE_IRI }).parse('<a> <b> <c>.\n<d> <e> <f>.\n<g> <h> <i>. # @group begin collection', (error, triple) => {

            },
            undefined,
            comment => expect(comment.value).toBe(' @group begin collection'), done(),
          );
      });
  });
});
